...
gulp.task('rev-assets', function() {
  ...
  var ignoreFont = '!' + path.resolve(process.env.PWD, PATH_CONFIG.dest, '**/*.{' + TASK_CONFIG.fonts.extensions + '}')

  return gulp.src([path.resolve(process.env.PWD, PATH_CONFIG.dest,'**/*'), ignoreThese, ignoreFont])
